...
import { 
  Search, Settings, Plus, Sun, Moon, Users, MapPin, Trophy, Loader2, Calendar, LayoutDashboard, Car, ChevronRight, Filter, FileDown, Check, X
} from 'lucide-react';
            ...
            {view === 'list' && (
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    {/* Filtro de Grupos (Barra Horizontal) */}
